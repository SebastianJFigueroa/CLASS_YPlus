 ...
 */
class_string_parameter(sBBN_withY_file,"/external/bbn/Alex_BBN_withY.dat","sBBN file")
class_string_parameter(sBBN_withY_deuterium_file,"/external/bbn/Alex_BBN_withY_Deuterium.dat","sBBN file")
class_string_parameter(sBBN_file,"/external/bbn/Alex_BBN.dat","sBBN file")
class_string_parameter(sBBN_deuterium_file,"/external/bbn/Alex_BBN_Deuterium.dat","sBBN file")

//class_string_parameter(sBBN_file,"/external/bbn/sBBN_2017.dat","sBBN file")
//class_string_parameter(sBBN_file,"/external/bbn/new_BBN.dat","sBBN file")
/*
...
class_precision_parameter(start_large_k_at_gamma_y_over_h, double, 1.0e-4)  /**< largest wavelengths start being sampled sufficiently before decay of Y particle. This is quantified in terms of the ratio of Y decay rate to hubble, \f$ Gamma_yp/H \f$. Start when this ratio equals start_large_k_at_gamma_y_over_h. Decrease this value to start integrating the wavenumbers earlier in time. */
...
/**
 * when to switch off tight-coupling approximation:
 * third condition: \f$ Gamma_yp/H \f$ <
 * tight_coupling_trigger_gamma_y_over_h.
 * Decrease this value to switch off earlier in time.
 */
class_precision_parameter(tight_coupling_trigger_gamma_y_over_h, double, 1.1e-4)
